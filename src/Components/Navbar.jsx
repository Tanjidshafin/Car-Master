...
export default function Navbar() {
    ...
    useEffect(() => setIsMobileMenuOpen(false), [locations.pathname])
    const routes = [
        { name: "Home", path: "/" },
                                ...
                                {routes.map((item, index) => (
                                    ...
                                    >
                                        <NavLink
                                            to={`${item.path}`}
                                            className={({ isActive }) =>
                                                `before:bg-[#3B9DF8] before:h-[2px] before:transition-all before:duration-300 before:absolute relative before:rounded-full before:bottom-[-2px] transition-all duration-300 before:left-0 cursor-pointer capitalize ${isActive ? "before:w-full text-[#3B9DF8]" : "before:w-0 hover:before:w-full"
